...
public class ConfigurationSingletonTest {
    ...
    void configurationTest() {
        ...
        OrderServiceImpl orderService = ac.getBean("orderService", OrderServiceImpl.class);//원래는 구체타입으로 꺼내는 건 안좋음
    ...
    void configurationDeep() {
        ...
        // AppConfig의 @Configuration을 함으로써 스프링컨테이너가 싱글톤으로 스프링 빈을 관리
    }
}
